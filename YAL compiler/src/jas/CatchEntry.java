...
public class CatchEntry
{
	 ...
	 * 
	 * @param start
	 *            Label marking the beginning of the area where the catch table is
	 *            active.
	 * @param end
	 *            Label marking the end of the area where the table is active.
	 * @param handler
	 *            Label marking the entrypoint into the exception handling routine.
	 * @param cat
	 *            (usually a classCP) informing the VM to direct any exceptions of
	 *            this (or its subclasses) to the handler.
	 * @see Catchtable
	 */
	 ...
	 * 
	 * @param start
	 *            offset marking the beginning of the area where the catch table is
	 *            active.
	 * @param end
	 *            offset marking the end of the area where the table is active.
	 * @param handler
	 *            offset marking the entrypoint into the exception handling routine.
	 * @param cat
	 *            (usually a classCP) informing the VM to direct any exceptions of
	 *            this (or its subclasses) to the handler.
	 * @see Catchtable
