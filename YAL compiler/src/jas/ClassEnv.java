...
/**
 * This is the place where all information about the class to be created
 * resides.
 *
...
public class ClassEnv implements RuntimeConstants
{
	 ...
	 * 
	 * @param name
	 *            CPE representing name for class. (This is usually a ClassCP)
	 */
	...
	/**
	 * Set the class access for this class. Constants understood by this are present
	 * along with the java Beta distribution.
	 * 
	 * @param access
	 *            number representing access permissions for the entire class.
	 ...
	 * Note that the CP ought to be a ClassCP to make sense to the VM.
	 */
	...
	/**
	 * Add this to the list of interfaces supposedly implemented by this class. Note
	 * that each CP is usually a ClassCP.
	 * 
	 * @param ilist
	 *            An array of CP items representing the interfaces implemented by
	 *            this class.
	 */
	...
	/**
	 * This is the method to add CPE items to a class. CPE items for a class are
	 * "uniquefied". Ie, if you add a CPE items whose contents already exist in the
	 * class, only one entry is finally written out when the class is written.
	 *
	 * @param cp
	 *            Item to be added to the class
	 */
	 ...
	 * 
	 * @param source
	 *            SourceAttribute specifying the source for the file
	 */
	 ...
	 * 
	 * @param debug
	 *            String the extended debug information
	 */
	 ...
	 * @param mtd
	 *            String the enclosing method
	 * @param dsc
	 *            String the enclosing method descriptor
	 */
	...
	/**
	 * Add a generic attribute to the class file. A generic attribute contains a
	 * stream of uninterpreted bytes which is ignored by the VM (as long as its name
	 * doesn't conflict with other names for attributes that are understood by the
	 * VM)
	 */
	...
	/**
	 * This allows more control over generating CP's for methods if you feel so
	 * inclined.
	 */
	...
	/**
	 * Change the bytecode version of this class The version will be
