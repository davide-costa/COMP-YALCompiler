...
public class CodeAttr
{
	...
	/**
	 * Create a new bag. Add instructions with the addInsn() method, set the catch
	 * table with the setCatchTable() method.
	 * 
	 * @see Insn
	 * @see Catchtable
	 * @see ClassEnv#addMethod
	...
	/**
	 * Add a generic attribute to the method. A generic attribute contains a stream
	 * of uninterpreted bytes which is ignored by the VM (as long as its name
	...
	/**
	 * Append a new Insn to this code. Insn's are sequentially stored, in the order
	 * in which this method is called. You can't reorder code fragments after you've
	 * added it here.
	 */
