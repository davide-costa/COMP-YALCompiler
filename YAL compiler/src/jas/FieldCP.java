...
public class FieldCP extends CP implements RuntimeConstants
{
	...
	/**
	 * FieldCP's are created by specifying the class to which the field belongs, the
	 * name of the symbol, and its signature. For instance, to refer to the field
	 * <tt>out</tt> in <tt>System.out</tt> use
