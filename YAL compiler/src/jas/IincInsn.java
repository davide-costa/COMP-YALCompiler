...
public class IincInsn extends Insn implements RuntimeConstants
{
	/**
	 * @param vindex
	 *            Index of variable to be incremented.
	 * @param increment
	 *            value to be added to the variable.
	 *
	 *            A wide prefix is automatically added if either the vindex exceeds
	 *            256, or the increment value lies outside the range [-128, 127]
	 *
	 ...
	 *            variable index 16 bit values for the wide version of this
	 *            instruction.
	 */
...
/*
 * --- Revision History --------------------------------------------------- ---
 * Iouri Kharon, Aug 10 2006 Added 'Wide' prefix support
 */
