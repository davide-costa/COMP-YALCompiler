...
public class LineTableAttr
{
	...
	/**
	 * Note: A line table is associated with a <em>method</em>, so you need to
	 * create a new LineTableAttr for each method for which you add debugging
	 * information.
	 * 
	 * @see CodeAttr#setLineTable
	 */
	 ...
	 * 
	 * @param l
	 *            to the location in the class file
	 * @param line
	...
	void write(ClassEnv e, CodeAttr ce, DataOutputStream out) throws IOException, jasError
	{
		...
		for (Enumeration en = pc.elements(), ien = line.elements(); en.hasMoreElements();)
		{
