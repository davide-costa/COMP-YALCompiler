...
public class LocalVarEntry
{
	 ...
	 * 
	 * @param startLabel
	 *            beginning of scope for variable
	 * @param endLabel
	 *            end of scope for variable
	 * @param name
	 *            name of variable
	 * @param sig
	 *            signature for variable
	 * @param slot
	 *            index of the local variable in the local variables registers of
	 *            the VM where its value can be found
	 */
	 ...
	 *            end of scope for variable
	 * @param name
	 *            CP to be associated as name of variable
	 * @param sig
	 *            CP to be associated as signature for variable
	 * @param slot
	 *            The index of the local variable in the local variables part of the
	 *            VM where its value can be found
	 */
