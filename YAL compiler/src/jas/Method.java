...
public class Method
{
	...
	/**
	 * @param macc
	 *            method access permissions. It is a combination of the constants
	 *            provided from RuntimeConstants
	 * @param name
	 *            CP item representing name of method.
	 * @param desc
	...
	void resolve(ClassEnv e)
	{
		...
		if (annInvis != null)
			annInvis.resolve(e);
		if (annParamVis != null)
			annParamVis.resolve(e);
		if (annParamInvis != null)
			annParamInvis.resolve(e);
		if (annDef != null)
			annDef.resolve(e);
	...
	void write(ClassEnv e, DataOutputStream out) throws IOException, jasError
	{
		...
		if (annParamVis != null)
			annParamVis.write(e, out);
		if (annParamInvis != null)
			annParamInvis.write(e, out);
		if (annDef != null)
			annDef.write(e, out);
		for (Enumeration gen = generic.elements(); gen.hasMoreElements();)
		{
