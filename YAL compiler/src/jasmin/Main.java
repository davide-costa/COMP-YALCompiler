...
/**
 * Main is the main entry point for Jasmin - it supplies the main() method, as
 * well as a few other useful odds and ends.
 */
public class Main
{
...
/*
 * --- Revision History --------------------------------------------------- ---
 * Iouri Kharon, May 07 2010, redesing for dynamic class creation --- Iouri
 * Kharon, Feb 17 2006, correct some IO diagnostics --- Jonathan Meyer, Mar 1
 * 1997 tidied error reporting, renamed Jasmin->ClassFile --- Jonathan Meyer,
 * Feb 8 1997 added the assemble() method --- Jonathan Meyer, July 24 1996 added
 * -version flag.
 */
