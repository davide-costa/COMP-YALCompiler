 ...
 * entries will either be SHIFT(state_num), REDUCE(production), or ERROR.
 * Objects of this base class will default to ERROR, while the other two types
 * will be represented by subclasses.
 * 
